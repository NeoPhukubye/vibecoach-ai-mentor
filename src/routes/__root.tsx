...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Setup — VibeCoach" },
      { property: "og:description", content: "Configure your AI interview practice session by pasting a job description." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Setup — VibeCoach" },
      { name: "twitter:description", content: "Configure your AI interview practice session by pasting a job description." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/2820700a-796a-466f-862c-79b07b7ce7f4" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/2820700a-796a-466f-862c-79b07b7ce7f4" },
    ],
    links: [
