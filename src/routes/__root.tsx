...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "VibeCoach — AI Interview Prep Simulator" },
      { name: "description", content: "Practice interviews with an AI avatar, get real-time analytics on clarity, filler words, and score." },
      { property: "og:title", content: "VibeCoach — AI Interview Prep" },
      { property: "og:description", content: "Practice interviews with an AI avatar and get instant performance analytics." },
